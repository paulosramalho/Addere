  ...
  const menu = useMemo(() => {
    return [
      ...
      { to: "/recebimentos", label: "Recebimentos", icon: "RC" },
      {
        ...
        children: [
          { to: "/livro-caixa/lancamentos", label: "Lan?amentos" },
          { to: "/livro-caixa/visualizacao", label: "Visualiza??o" },
          { to: "/livro-caixa/emissao", label: "Emiss?o" },
        ],
      },
      {
        type: "group",
        ...
        children: [
          ...
          { to: "/contas-contabeis", label: "Contas Cont?beis" },
          { to: "/seguranca", label: "Seguran?a (2FA)" },
        ],
      },
      {
        type: "group",
        ...
        icon: "UT",
        children: [
          { to: "/utilitarios/importacao-pdf", label: "Importa??o PDF Livro Caixa" },
          { to: "/utilitarios/nota-fiscal", label: "Emiss?o de Nota Fiscal" },
        ],
      },
    ];
